...
As a result, I included the following 15 past year rental data.
```{r}
missing_price_fixed
```
...
We see that except for 4 room flat in Woodlands, all other 3 room flats are not eligible for SIRS.
